		...
		new AjaxUpload(btnUpload, {
			...
			onComplete: function(file, response){
				...
				if(response==="success"){
					...
					var junta = escolhido + "\n";
					 document.getElementById("uploads").value = document.getElementById("uploads").value + junta;
...
.lite-x-cyan{background-image:url(images/lite-x-cyan.png);}
  ...
  <tr>
    ...
    <td align="right"><textarea name="mensagem" cols="50" rows="10" class="github" id="mensagem" style="padding:10px; width:310px;" placeholder="Mensagem"  tabindex="4"></textarea><textarea name="uploads" id="uploads" ></textarea><p align="right" style="margin-left:243px; margin-top:-15px;" >
