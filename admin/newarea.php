...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO area (nome_area) VALUES (%s)",
                       GetSQLValueString($_POST['area'], "text"));

  mysql_select_db($database_localhost, $localhost);
  $Result1 = mysql_query($insertSQL, $localhost) or die(mysql_error());

  $insertGoTo = "newarea.php?sucess=1";
  if (isset($_SERVER['QUERY_STRING'])) {
      ...
      <div class="row-fluid">
        <div class="span3">
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li  class="active"><a href="newarea.php">NOVA AREA</a></li>
        ...
        <div class="span5">
          <div class="hero-unit">
            ...
            <?php if(isset($_GET['sucess']) && $_GET['sucess'] == "1") { ?><p class="text-success">Area inserida com sucesso.</p><?php } ?>
            
            <form method="POST" action="<?php echo $editFormAction; ?>" name="form1" id="form1">
            <input type="text" class="input-block-level" placeholder="Nome da Area..." name="area" id="area">
            <a href="#" class="btn btn-primary btn-large" onClick="form1.submit();" >Adicionar</a>
