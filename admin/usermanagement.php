...
$query_users = "SELECT * FROM administrador ORDER BY username ASC";
...
<p>&nbsp;</p>
  ...
  <tr>
    ...
    <td align="right"><?php echo $row_users['password']; ?></td>
    <td align="right">
  <div class="btn-group">
  <a class="btn btn-primary" href="#"><i class="icon-user icon-white"></i> Acção</a>
  <a class="btn btn-primary dropdown-toggle" data-toggle="dropdown" href="#"><span class="caret"></span></a>
  <ul class="dropdown-menu">
    <li><a href="edituser.php?idadministrador=<?php echo $row_users['idadministrador']; ?>"><i class="icon-pencil"></i> Editar</a></li>
    <li><a href="deleteuser.php?idadministrador=<?php echo $row_users['idadministrador']; ?>"><i class="icon-trash"></i> Apagar</a></li>
  </ul>
</div></td>
