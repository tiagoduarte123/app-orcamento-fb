...
$query_areas = "SELECT * FROM servico ORDER BY nome_servico ASC";
$areas = mysql_query($query_areas, $localhost) or die(mysql_error());
$row_areas = mysql_fetch_assoc($areas);
$totalRows_areas = mysql_num_rows($areas);

mysql_select_db($database_localhost, $localhost);
$query_servicoarea = "SELECT area.nome_area, servico.nome_servico, servico.idservico FROM area, servico WHERE servico.idarea = area.idarea";
$servicoarea = mysql_query($query_servicoarea, $localhost) or die(mysql_error());
$row_servicoarea = mysql_fetch_assoc($servicoarea);
$totalRows_servicoarea = mysql_num_rows($servicoarea);

mysql_select_db($database_localhost, $localhost);
$query_serarea = "SELECT servico.idservico, servico.nome_servico, area.nome_area FROM servico, area WHERE servico.idarea = area.idarea";
$serarea = mysql_query($query_serarea, $localhost) or die(mysql_error());
$row_serarea = mysql_fetch_assoc($serarea);
$totalRows_serarea = mysql_num_rows($serarea);
...
<p>&nbsp;</p>
  ...
  <tr>
    <td><font color="#CCCCCC">Nome do Serviço</font>
    <td><font color="#CCCCCC">Area</font>
    <td>
     
      <?php do { ?>
    <tr>
    <td><?php echo $row_serarea['nome_servico']; ?></td>
    <td align="right"><?php echo $row_serarea['nome_area']; ?></td>
    <td align="right">
  <div class="btn-group">
  <a class="btn btn-primary" href="#"><i class="icon-user icon-white"></i> Acção</a>
  <a class="btn btn-primary dropdown-toggle" data-toggle="dropdown" href="#"><span class="caret"></span></a>
  <ul class="dropdown-menu">
    <li><a href="editservico.php?idservico=<?php echo $row_serarea['idservico']; ?>"><i class="icon-pencil"></i> Editar</a></li>
    <li><a href="deleteservico.php?idservico=<?php echo $row_serarea['idservico']; ?>"><i class="icon-trash"></i> Apagar</a></li>
  </ul>
</div></td>

</tr>
    <?php } while ($row_serarea = mysql_fetch_assoc($serarea)); ?>
...
mysql_free_result($servicoarea);

mysql_free_result($serarea);
?>
