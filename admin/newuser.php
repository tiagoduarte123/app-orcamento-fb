...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO administrador (username, password) VALUES (%s, %s)",
  ...
  $insertGoTo = "newuser.php?sucess=1";
  if (isset($_SERVER['QUERY_STRING'])) {
          ...
          <div class="hero-unit">
            ...
            <form action="<?php echo $editFormAction; ?>" method="POST" name="form1" id="form1">
              <table width="100%" border="0">
                <tr>
                  <td><input type="text" class="input-block-level" placeholder="Utilizador/Email" name="user" id="user"></td>
                </tr>
                <tr>
                  <td><input type="text" class="input-block-level" placeholder="Senha..." name="senha" id="senha"></td>
                </tr>
              </table>
