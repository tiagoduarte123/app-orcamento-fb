...
mysql_select_db($database_localhost, $localhost);
$query_area = sprintf("SELECT * FROM area WHERE idarea = %s", GetSQLValueString($colname_area, "int"));
