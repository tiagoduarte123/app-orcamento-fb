...
$query_areas = "SELECT * FROM administrador";
...
<p>&nbsp;</p>
  ...
  <tr>
    <td><font color="#CCCCCC">Utilizador</font>
    <td><font color="#CCCCCC">Senha   </font> 
    <td>
     
      <?php do { ?>
    <tr>
    <td><?php echo $row_areas['username']; ?></td>
    <td align="right"><?php echo $row_areas['password']; ?></td>
    <td align="right">
  <div class="btn-group">
  <a class="btn btn-primary" href="#"><i class="icon-user icon-white"></i> Acção</a>
  <a class="btn btn-primary dropdown-toggle" data-toggle="dropdown" href="#"><span class="caret"></span></a>
  <ul class="dropdown-menu">
    <li><a href="edituser.php?idadministrador=<?php echo $row_areas['idadministrador']; ?>"><i class="icon-pencil"></i> Editar</a></li>
    <li><a href="deleteuser.php?idarea=<?php echo $row_areas['idadministrador']; ?>"><i class="icon-trash"></i> Apagar</a></li>
  </ul>
</div></td>
