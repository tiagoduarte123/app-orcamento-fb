...
input.placeholder = "Preenche este campo corretamente";
document.getElementById("nome").focus();
erro=erro+1;
}

if(document.getElementById("telefone").value == "" || document.documentElement("telefone").length < 12){
...
if( document.forms['formulario'].email.value=="" 
   || document.forms['formulario'].email.value.indexOf('@')==-1 
     || document.forms['formulario'].email.value.indexOf('.')==-1 )
	{
		var input = document.getElementById("email");
input.placeholder = "Utilize um email válido.";
		erro=erro+1;
    ...
    <tr>
      <td colspan="2" align="center"><center>
        <table width="100%" border="0">
          <tr>
            <td width="35%">&nbsp;</td>
            <td width="56%"><input type="text" class="jquery-lightbox-overlay" id="amount" name="amount" style="border: 0; color: #FFF; font-weight: bold; font:impact; size:10pt" readonly="readonly"  /></td>
            <td width="9%">&nbsp;</td>
          </tr>
        </table>
      </center></td>
...
<div id="apDiv15">
   ...
   <a href="#lastone"> <input type="submit" id="gform_submit_button_4" class="button gform_button" value="Enviar" tabindex="5" onclick="CopyDivsToTextArea();" /></a>
</div>
...
<p>&nbsp;</p>
<form id="formulario" name="formulario" action="sendmail.php" method="post" onsubmit="return CopyDivsToTextArea();">
<table width="1103" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="66">&nbsp;</td>
    <td width="360"> <h3>Serviços Selecionados</h3></td>
    <td width="677" align="right"><input name="nome" type="text" required="required" class="form" id="nome" placeholder="Nome" style="padding:10px; width:310px;" tabindex="1" value="" /></td>
  </tr>
  <tr>
...
.lite-x-cyan{background-image:url(images/lite-x-cyan.png);}
    ...
    <td align="right"><input type="text" name="telefone" id="telefone" value="" tabindex="1" style="padding:10px; width:310px;" placeholder="Telefone" class="form" />      <br />      <input type="text" name="empresa" id="empresa" value="" tabindex="2" style="padding:10px; width:310px;" placeholder="Empresa" class="form" /></td>
  </tr>
  <tr>
    <td align="right"><input type="email" name="email" id="email" value="" tabindex="1" style="padding:10px; width:310px;" placeholder="E-mail" class="form" /><input type="hidden" name="teste2" id= "teste2"></td>
  </tr>
  <tr>
    <td valign="top">&nbsp;</td>
    <td height="190" valign="top">&nbsp;</td>
    <td align="right"><textarea name="mensagem" cols="50" rows="10" class="github" id="mensagem" style="padding:10px; width:310px;" placeholder="Comentário"  tabindex="4"></textarea><textarea id="selecao" name="selecao" style="visibility:hidden" ></textarea></td>
  </tr>
</table></form>
<!-- imagem 4 --><!-- fim imagem -->
