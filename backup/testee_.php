...
<title>Agência Criativa Imagem - Agência Digital | Criação de Sites, Produção de Vídeos, Mídias Impressas, Campanhas de Marketing...</title>

<meta http-equiv="X-UA-Compatible" content="IE=EmulateIE8" />

<meta name="resource-type" content="document" />
<meta name="classification" content="Internet" />
<meta name="author" content="Agência Criativa Imagem" />

<meta name="description" content="Agência Criativa Imagem | Criação de Sites, Produção de Vídeos, Campanhas de Marketing, Mídias Impressas..." />

<meta name="keywords" content="Criativa Imagem, criação, criativa, imagem, agência, publicidade, São Paulo, SP, criação, produção, veiculação, mídia, impressa, eletrônica, digital, marketing, promocional, programação, visual, criação de site, criação de website, criativaimagem, criação site, desenvolvimento de website, desenvolvimento de site, mailing, web marketing, disparo de mailing, publicidade, agencia de publicidade, site grátis, site gratis, site empresarial, criação e desenvolvimento de sites, criação de sites, logotipo, criação de logotipo, publicidade e propaganda, desenvolvimento de logotipo, mídia digital," />
...
<meta name="DC.title" content="Agência Criativa Imagem" />
<meta property="og:image" content="images/5.jpg"/>	
<link rel="shortcut icon" href="http://www.agenciacriativaimagem.com.br/img/favicon.png">		
...
<!-- FLIP DA PARTE DE SERVIÇOS -->
<script type="text/javascript" src="js/jquery.1.7.1.min.js"></script>
<script type="text/javascript" src="js/jquery.easing.1.3.js"></script>	
<script type="text/javascript" src="js/modernizr.2.5.3.min.js"></script>	
<link rel="stylesheet" href="js/style.css" type="text/css" media="screen">
<!-- FIM - FLIP DA PARTE DE SERVIÇOS -->
...
<div id="apDiv5"><img src="images/logo.png" /></div>
...
<div id="apDiv8">
 <a href="#secondstep"><input type="submit" id="gform_submit_button_4" class="button gform_button" value="&#8743     Próximo" tabindex="5" onclick="verificastep1();" /></a></div>
...
<div id="apDiv11"> 
<a href="#thirdstep"><input type="submit" id="gform_submit_button_4" class="button gform_button" value="&#8743     Próximo" tabindex="5" onclick="#thirdstep" /></a>
  ...
  <tr>
    <td colspan="2" align="center"><CENTER>
      <table width="100%" border="0">
        <tr>
          <td width="35%">&nbsp;</td>
          <td width="56%"><input type="text" class="jquery-lightbox-overlay" id="amount" style="border: 0; color: #FFF; font-weight: bold; font:impact; size:10pt" readonly="readonly"  /></td>
          <td width="9%">&nbsp;</td>
        </tr>
      </table>
    </CENTER></td>
...
<div id="apDiv15">
   ...
   <a href="#lastone"> <input type="submit" id="gform_submit_button_4" class="button gform_button" value="Enviar" tabindex="5" onclick="#cima" /></a>
</div>
...
<script type="IN/CompanyProfile" data-id="2812349" data-format="hover" data-related="false"></script>
...
<div id="apDiv4">
  <div class="gform_footer top_label">
    <a href="#fourstep"><input type="submit" id="gform_submit_button_4" class="button gform_button" value="&#8743     Próximo" tabindex="5" onclick="#cima" /></a>
...
<table width="1103" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="677" align="right"><input type="text" name="nome" id="nome" value="" tabindex="1" style="padding:10px; width:310px;" placeholder="Nome" /></td>
  </tr>
  <tr>
    <td rowspan="2" valign="top">&nbsp;</td>
    <td rowspan="2" valign="top"><p>- Web Soluções<br />
      - Comunicação visual</p>
      <p>&nbsp;</p></td>
    <td align="right"><input type="text" name="nome" id="nome" value="" tabindex="1" style="padding:10px; width:310px;" placeholder="Telefone" />      <br />      <input type="text" name="nome" id="nome" value="" tabindex="1" style="padding:10px; width:310px;" placeholder="Empresa" /></td>
  </tr>
  <tr>
    <td align="right"><input type="text" name="nome" id="nome" value="" tabindex="1" style="padding:10px; width:310px;" placeholder="E-mail" /></td>
  </tr>
  <tr>
    <td valign="top">&nbsp;</td>
    <td height="190" valign="top">&nbsp;</td>
    <td align="right"><textarea name="mensagem" cols="50" rows="10" class="github" id="mensagem" style="padding:10px; width:310px;" placeholder="Comentário"  tabindex="4"></textarea></td>
  </tr>
</table>
<!-- imagem 4 --><!-- fim imagem -->
...
.big-checkbox:checked + label:after {
  ...
  <tr>
   <td height="27" valign="middle" style="font-family:'HelveticaNeueLTPro Lt'; color:#FFF; font-size:20px"><?php echo $row_relacional['nome_servico']; ?></td>
    <td><input type="checkbox" id="<?php echo $row_relacional['idservico']; ?>" class="regular-checkbox" />
              ...
              <table width="100%" border="0">
                <?php do { ?>
                  <tr>
                    ...
                    <td><input type="checkbox" id="<?php echo $row_marketingperformance['idservico']; ?>" class="regular-checkbox" />
                      <label for="<?php echo $row_marketingperformance['idservico']; ?>"></label></td>
                    </tr>
...
.big-checkbox:checked + label:after {
	...
	left: 6px;
      ...
      <?php do { ?>   <tr>
          ...
          <td>
          <input value="<?php echo $row_ativacaodigital['nome_servico']; ?>" type="checkbox" id="<?php echo $row_ativacaodigital['idservico']; ?>" class="regular-checkbox" name="step1[]" /><label for="<?php echo $row_ativacaodigital['idservico']; ?>"></label></td>
