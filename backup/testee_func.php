...
<div id="apDiv15">
   ...
   <a href="#lastone"> <input type="submit" id="gform_submit_button_4" class="button gform_button" value="Enviar" tabindex="5" onclick="colar();" /></a>
</div>
...
.lite-x-cyan{background-image:url(images/lite-x-cyan.png);}
  ...
  <tr>
    ...
    <td align="right"><textarea name="mensagem" cols="50" rows="10" class="github" id="mensagem" style="padding:10px; width:310px;" placeholder="Comentário"  tabindex="4"></textarea>
      <textarea id="conteudo" name="conteudo" style="visibility:hidden"></textarea></td>
  </tr>
</table></form>
<!-- imagem 4 --><!-- fim imagem -->
