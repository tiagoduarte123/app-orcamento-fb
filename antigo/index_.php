...
.lite-x-cyan{background-image:url(images/lite-x-cyan.png);}
  ...
  <tr>
    <td align="right"><input type="email" name="email" id="email" value="" tabindex="1" style="padding:10px; width:310px;" placeholder="E-mail" /><input type="hidden" name="teste2" id= "teste2"></td>
  </tr>
  <tr>
    <td valign="top">&nbsp;</td>
