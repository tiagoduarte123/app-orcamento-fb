...
<div id="apDiv15">
   ...
   <input type="submit" id="gform_submit_button_4" class="button gform_button" value="Enviar" tabindex="5" onclick="teste.submit();" />
</div>
...
.lite-x-cyan{background-image:url(images/lite-x-cyan.png);}
  ...
  <tr>
    <td align="right"><input name="email" id="email" type="email" title="email" placeholder="Your e-email address here" required /><input type="hidden" name="teste2" id= "teste2"></td>
  </tr>
  <tr>
    <td valign="top">&nbsp;</td>
