...
function myFunction()
{
//var conteudo = Document.getElementById('total');4

var tudo = document.getElementById("total").innerHTML.toString();


alert(jQuery(tudo).text());

var link = "mailto:tiago7a@hotmail.com"
             + "&subject=" + escape("Ajuda")
             + "&body=" + jQuery(tudo).text()
  ...
  <SCRIPT LANGUAGE="JavaScript">
		...
		document.getElementById("total").innerHTML="";
         ...
         function outputSelected(opt) {
            ...
            for (var item in sel) {      
			strSel = strSel + '<div id="' + sel[item].id + '">' + sel[item].value + '<input type="checkbox" id="'+ sel[item].id +'1" class="css-checkbox" checked="checked" onclick="$(this).parent().remove();"/><label for="'+ sel[item].id +'1" name="checkbox9_lbl" class="css-label lite-x-cyan"></label></div>';//strSel + '<div id="' + '1">' + sel[item].value + '<input value="' + sel[item].value + '"' + 'type="checkbox" id="' + sel[item].id + '"' + 'class="css-checkbox" name="' + sel[item].name + '"' + 'onclick="' +  "$(this).parent().remove();" + '"' + ' checked><label for="' + sel[item].id + '"></label></div>';
...
<script src="js/jquery-ui.js"></script>
 ...
 <script language="javascript">
  function email() {
    var conteudo = document.getElementById("total").innerHTML.toString();
	document.getElementById("teste2").value = conteudo;
...
<div id="apDiv15">
   ...
   <a href="#lastone"> <input type="submit" id="gform_submit_button_4" class="button gform_button" value="Enviar" tabindex="5" onclick="formulario.submit();" /></a>
</div>
...
<p>&nbsp;</p>
<form id="formulario" action="sendmail.php" method="post">
...
.lite-x-cyan{background-image:url(images/lite-x-cyan.png);}
    ...
    <td align="right"><input type="text" name="telefone" id="telefone" value="" tabindex="1" style="padding:10px; width:310px;" placeholder="Telefone" />      <br />      <input type="text" name="empresa" id="empresa" value="" tabindex="2" style="padding:10px; width:310px;" placeholder="Empresa" /></td>
  </tr>
  <tr>
    <td align="right"><input type="text" name="email" id="email" value="" tabindex="1" style="padding:10px; width:310px;" placeholder="E-mail" /><input type="hidden" name="teste2" id= "teste2"></td>
  </tr>
  <tr>
    <td valign="top">&nbsp;</td>
