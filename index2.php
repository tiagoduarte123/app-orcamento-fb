...
<div id="apDiv17"><div style="font-family:impact; color:#FFF; font-size:30px; text-shadow: 1px 0px 10px #000000;filter: dropshadow(color=#000000, offx=1, offy=0);">Siga-nos em</div>
  ...
  <a href="https://twitter.com/Legendaryptl" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image13','','images/icon/twitter_2.png',1)"><img src="images/icon/twitter_1.png" name="Image13" id="Image13"></a>
<a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image14','','images/icon/google_2.png',1)"><img id="Image14" src="images/icon/google_1.png"></a> 
<a href="http://www.linkedin.com/company/legendary-people-ideas" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image15','','images/icon/linkedin_2.png',1)"><img src="images/icon/linkedin_1.png" name="Image15" id="Image15"></a> 
...
<p>&nbsp;</p>
<form id="teste" onSubmit="CopyDivsToTextArea();" action="" name="formxml" method="post">
...
.lite-x-cyan{background-image:url(images/lite-x-cyan.png);}
  ...
  <tr>
    ...
    <input type="submit" value="Enviar" id="last" name="last"></p><textarea id="selecao" name="selecao" style="visibility:hidden" ></textarea>
    </td>
  </tr>
