  ...
  <SCRIPT LANGUAGE="JavaScript">
		...
		document.getElementById("total").innerHTML="";
         ...
         function outputSelected(opt) {
            ...
            for (var item in sel) {      
			strSel = strSel + '<div id="' + sel[item].id + '"class='+'"test1"'+'>' + sel[item].value + '<input type="checkbox" id="'+ sel[item].id +'1" class="css-checkbox" checked="checked" onclick="$(this).parent().remove();"/><label for="'+ sel[item].id +'1" name="checkbox9_lbl" class="css-label lite-x-cyan" align="right"></label></div>';//strSel + '<div id="' + '1">' + sel[item].value + '<input value="' + sel[item].value + '"' + 'type="checkbox" id="' + sel[item].id + '"' + 'class="css-checkbox" name="' + sel[item].name + '"' + 'onclick="' +  "$(this).parent().remove();" + '"' + ' checked><label for="' + sel[item].id + '"></label></div>';
    ...
    <tr>
      <td colspan="2" align="center"><center>
        <table width="100%" border="0">
          <tr>
            <td width="35%">&nbsp;</td>
            <td width="56%"><input type="text" class="jquery-lightbox-overlay" id="amount" name="amount" style="border: 0; color: #FFF; font-weight: bold; font:impact; size:10pt" readonly  /></td>
            <td width="9%">&nbsp;</td>
          </tr>
        </table>
      </center></td>
...
<p>&nbsp;</p>
<form id="teste" onSubmit="CopyDivsToTextArea();" action="sendmail.php">
...
.lite-x-cyan{background-image:url(images/lite-x-cyan.png);}
  ...
  <tr>
    <td align="right">
    <input name="email" id="email" type="email" title="email" tabindex="3" style="padding:10px; width:310px;" placeholder="E-mail" class="form" required/><input type="hidden" name="teste2" id= "teste2"></td>
  </tr>
  <tr>
    <td valign="top">&nbsp;</td>
    <td height="190" valign="top">&nbsp;</td>
    <td align="right"><textarea name="mensagem" cols="50" rows="10" class="github" id="mensagem" style="padding:10px; width:310px;" placeholder="Comentário"  tabindex="4"></textarea><p align="right" style="margin-left:243px; margin-top:-15px;" ><input type="submit" value="Enviar"></p><textarea id="selecao" name="selecao" style="visibility:hidden" ></textarea></td>
  </tr>
